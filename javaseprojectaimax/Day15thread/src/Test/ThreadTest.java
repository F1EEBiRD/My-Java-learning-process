...
public class ThreadTest {
    ...
    //现在公司举办了年会活动，活动中有一个红包雨环节，要求共计发出200个红包雨。其中小红包[1 - 30] 元之间
    // 总占比为80%，大红包[31 - 100]元之间，总占比为20%
    //分析：100个员工实际是100个线程，来竞争200个红包
...
//1.准备200个随机红包返回，放到List集合中去返回
public static List<Integer> getRedPacket() {
        //其中小红包在[1 - 30]元之间，占比80%，大红包在[31 - 100]元之间，占比20%
    Random r = new Random();
